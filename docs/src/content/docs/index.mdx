...
- [React + Vite + i18next](https://github.com/localeops/localeops/tree/main/examples/react-vite-i18next) - Ready-to-use i18next template
- [React + Vite + FormatJS](https://github.com/localeops/localeops/tree/main/examples/react-vite-formatjs) - Ready-to-use FormatJS template
